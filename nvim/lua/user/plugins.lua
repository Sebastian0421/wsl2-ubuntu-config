...
return packer.startup(function(use)
  ...
  use "nvim-lua/popup.nvim" -- An implementation of the Popup API from vim in Neovim 弹窗
  ...
  use "mstanciu552/cmp-matlab" --matlab completion
  ...
  use "tpope/vim-surround" -- vim surround 改包含符号ysiw",ds",cs"’
  -- use "terryma/vim-expand-region" -- expand/shrink region by +/-
  -- use "meain/vim-printer"

  use "akinsho/toggleterm.nvim" -- toggle terminal
  use "ahmedkhalf/project.nvim" -- project manager 浮动
...
-- MATLAB edition
  ...
  use "HaoHao-Ting/vim-matlab-formatter" --matlab格式化:matlabformatter
  use "yinflying/matlab.vim" --您可以使用“=”自动对齐；你可以通过":make" 和":copen" 来检查matlab错误，并且":cn"&":cp" 跳转到错误行；
  use "tmhedberg/matchit" -- 匹配ifend
